...
const basePath = '/kolo-mee-stinablis-1775448153087';
...
export default function Home() {
  ...
  const products = [{ n: 'Mee Kolo Putih', d: 'Our signature Mee Kolo Putih is a delicious and authentic white kolo mee dish made with tender noodles, savory sauce, and a blend of aromatic spices. This mouth-watering dish is a must-try for any kolo mee enthusiast.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80', icon: 'domain' }, { n: 'Mee Kolo Merah', d: 'Indulge in our flavorful Mee Kolo Merah, a rich and spicy red kolo mee variant that combines the perfect balance of sweet and sour flavors with a kick of heat, sure to tantalize your taste buds.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&q=80', icon: 'architecture' }, { n: 'Mee Kolo Kicap', d: 'Savor the distinct taste of our Mee Kolo Kicap, a soy sauce-based kolo mee dish that offers a depth of umami flavor, paired with our signature noodles and a hint of herbs, creating a truly satisfying culinary experience.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&q=80', icon: 'chair' }, { n: 'Wantan', d: 'Complement your kolo mee meal with our crispy and savory wantan, carefully crafted to provide a delightful contrast in texture and flavor to our noodle dishes, ensuring a well-rounded dining experience.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80', icon: 'eco' }, { n: 'Mee Pok', d: 'Enjoy our Mee Pok, a flat noodle variant that showcases the versatility of our kolo mee products, offering a unique texture and taste that pairs perfectly with our range of sauces and accompaniments.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&q=80', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Kolo mee stinablis is a reputable noodle manufacturer dedicated to serving the best kolo mee dishes with a wide variety of flavors to cater to diverse customer preferences. Our mission is to provide high-quality products that exceed customer expectations. With a strong focus on customer satisfaction, we strive to build long-lasting relationships with our clients.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading kolo mee brand in the industry, recognized for our commitment to quality, customer satisfaction, and innovative products.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver exceptional kolo mee products and services that meet the evolving needs of our customers, while maintaining the highest standards of quality, safety, and customer experience.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer First</h4>
                  <p className="text-sm text-on-surface-variant">At Kolo mee stinablis, we prioritize our customers\' needs and preferences, ensuring that every interaction with our brand is met with exceptional service, attention to detail, and a personal touch.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Quality</h4>
                  <p className="text-sm text-on-surface-variant">We are dedicated to maintaining the highest quality standards in our products, manufacturing processes, and supply chain management to guarantee the best kolo mee experience for our customers.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&q=80" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200&q=80" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
